...
describe("DependenciesComponent", () => {
  ...
  beforeEach(() => {
    ...
    td.when(anotherDummyServiceMock.lovelyMethod()).thenReturn({
      text: lovelyText,
    });
  ...
  it('should show "awesome" when component calling to oninit hook', () => {
    fixture.detectChanges();
  ...
  it("should use TestBed.inject to get the dummyservice instance", () => {
    //mediante el Testbed.inject() podemos obtener la instancia de servicios, pipes...
    const anotherDummyServiceInstance: AnotherDummyService =
      TestBed.inject(AnotherDummyService);

    expect(anotherDummyServiceInstance.lovelyMethod()).toEqual({
      text: lovelyText,
    });
  });
});
